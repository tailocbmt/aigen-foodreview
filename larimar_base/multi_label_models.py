...
class FakeNewsMultimodalFinetune(FakeNewsMultimodalWMemory):
    def __init__(
        self,
        out_dim=1,
        use_memory=True,
    ...
    def forward(self, inputs, indexes=None, return_memory=False, return_interpretability=False, top_k=None):
        outputs = {}
        x, text_attention = self.feature_extractor(
            inputs, return_interpretability)
